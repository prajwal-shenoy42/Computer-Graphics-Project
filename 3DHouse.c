...
void first()
{
	...
	glColor3f(0, 0.5, 0.5);
	strokeString(360, 390, 0.4, 0.4, "3D HOUSE", 6);
	glColor3f(0.54, 0, 0);
	strokeString(50, 50, 0.17, 0.17, "Press (Enter) to display the house", 2);
	strokeString(610, 200, 0.15, 0.15, "By:", 2);
	strokeString(610, 60, 0.15, 0.15, "Under the guidance of.", 2);
	glColor3f(0.74,0.72,0.42);
	strokeString(610, 160, 0.18, 0.18, "Yashas H, Prajwal Shenoy", 2);
	strokeString(610, 30, 0.2, 0.2, "Shankar R(Assistant Professor)", 2);
	strokeString(610, 120, 0.18, 0.18, "1BY18CS191, 1BY18CS224", 2);
	glutSwapBuffers();
}		
